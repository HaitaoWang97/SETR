...
class TransFpnHead(BaseDecodeHead):
    """ Vision Transformer with support for patch or hybrid CNN input stage
    """

    def __init__(self, img_size=768, embed_dim=256,
        ...
        super(TransFpnHead, self).__init__(**kwargs)
    ...
    def forward(self, x):
        ...
        # print("===================", 'input size in decoder', x.shape, '============================') # n, c, h, w
        x = x[0]
        if x.dim() == 3:
            if x.shape[1] % 48 != 0:
                x = x[:, 1:]
